...
class PackageMinGW(AutoToolsPackageBase):
    def __init__(self, **args):
        ...
        self.subinfo.options.configure.args += " --disable-static --enable-shared --disable-java --disable-native-java --enable-nls --enable-c++ --with-included-gettext --with-included-glib --with-included-regex "
